...
namespace OneLogin
{
    public class AppSettings
    {
        ...
        //public string assertionConsumerServiceUrl = "http://172.16.18.9/project/supattra/StudentAttendance-sso/Login/ssoLogin.cshtml"; // แก้ตรงนี้ url หน้าแรกที่ลอกอินได้
        //public string identityId = "http://172.16.18.9/project/supattra/StudentAttendance-sso"; //ตรงนี้url project 
        public string assertionConsumerServiceUrl = "http://cpe.rmuti.ac.th/project/StudentAttendance-sso/Login/ssoLogin.cshtml"; // แก้ตรงนี้ url หน้าแรกที่ลอกอินได้
        public string identityId = "http://cpe.rmuti.ac.th/project/StudentAttendance-sso"; //ตรงนี้url project 
    }
